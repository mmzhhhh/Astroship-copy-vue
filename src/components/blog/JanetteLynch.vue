<template>
    <div>
        ...
        <div class=" mx-auto max-w-3xl mt-[70px]">
            <span class=" text-blue-400 uppercase tracking-wider text-sm font-medium">{{ blog[1].title }}</span>
            <h1 class=" text-4xl lg:text-5xl font-bold lg:tracking-tight mt-[5px] lg:leading-tight">{{
                blog[1].introduction }}</h1>
            <div class=" flex gap-2 mt-[15px] items-center flex-wrap">
                <span class=" text-gray-400">{{ blog[1].author }}</span>
                <span class=" text-gray-400">.</span>
                <time class=" text-gray-400">{{ blog[1].time }}</time>
